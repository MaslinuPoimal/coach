...
from rl_coach.filters.action.action_adversarial_noise import ActionAdversarialNoise
...
agent_params.output_filter.add_action_filter('random_action', ActionAdversarialNoise())
