...
from rl_coach.filters.action.action_noise import ActionNoise
...
agent_params.input_filter = OutputFilter()
agent_params.input_filter.add_action_filter('output_damage', ActionNoise())
